...
// //         <article
// //           key={index}
// //           className="flex flex-col justify-between p-12 min-h-[500px]"
// //           style={{ 
...
// //             </p>
// //           </div>
// //           <button className="bg-[#1960E6] text-white font-bold py-3 px-6 w-fit hover:bg-blue-700 transition-colors mt-8">
// //             READ PRESS RELEASE
// //           </button>
// //         </article>
// //       ))}
